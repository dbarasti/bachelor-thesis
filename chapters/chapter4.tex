...
Per ottenere un'architettura solida e manutenibile è stato scelto di gestire separatamente le operazioni di lettura e scrittura. Nella soluzione sviluppata, per ogni PLC saranno utilizzati due componenti: \gls{tagpoller} e \gls{tagupdater}.
\begin{itemize}
