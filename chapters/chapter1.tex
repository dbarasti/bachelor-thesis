...
\end{wrapfigure}
La {\acrshort{bu} interessata dallo stage è JMES, composta da 20 persone tra sistemisti e sviluppatori, che si occupa dell'omonimo applicativo MES utilizzato nell'ambito della \textit{\gls{digital industry}}. Questo software serve a gestire e supervisionare l'avanzamento della produzione all'interno della fabbrica.
...
\begin{itemize}
	...
	\item Il capitolo \nameref{ch:problematiche} intende presentare i problemi che hanno portato alla proposta di stage. Verrà analizzato il sistema precedentemente sviluppato da \acrshort{smi} e si presenteranno i requisiti estratti da questo. 
