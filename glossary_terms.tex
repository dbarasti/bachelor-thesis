...
\newglossaryentry{polling}{name={\textit{polling}},description={Attività che viene effettuata ripetutamente per verificare il cambiamento di un certo stato. Nell'ambito del progetto l'attività di polling è quella effettuata nei confronti dei PLC per rilevare cambiamenti nei dati al suo interno.}}


\newglossaryentry{benchmark}{name={\textit{benchmark}},description={}}

\newglossaryentry{thread}{name={\textit{thread}},description={description}}

\newglossaryentry{engine}{name={\textit{Engine}},description={description}}

\newglossaryentry{tagpoller}{name={\textit{TagPoller}},description={description}}

\newglossaryentry{tagupdater}{name={\textit{TagUpdater}},description={description}}

\newglossaryentry{tag}{name={\textit{Tag}},description={description}}

\newglossaryentry{pollingtagrepository}{name={\textit{PollingTagRepository}},description={description}}

\newglossaryentry{tagupdaterrepository}{name={\textit{TagUpdaterRepository}},description={description}}

\newglossaryentry{tagconfiguration}{name={\textit{TagConfiguration}},description={description}}

\newglossaryentry{configurator}{name={\textit{Configurator}},description={description}}